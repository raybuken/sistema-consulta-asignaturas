...
import { getSubjectsType, updateSubject } from '../../helpers/subject/subjectHelpers';
import { editSubjectSchema } from '../../validations/subject';
import { useState } from 'react';

function EditSubjectForm({id, subjectData}) {
  const [types, setTypes] = useState([])

  const toast = useToast()
  const initialValues = {
    knowledgeAreaID: subjectData.knowledgeAreaID,
    ...
    studentQuota: subjectData.studentQuota,
      ...
      .then(data => {
        if(!data.ok){
          ...
          toast({
            ...
            description: "Campos de la asignatura actualizado",
          })
        }
  ...
  return (
    <Box rounded='md' padding='5' boxShadow='lg' role='group' minH={400} w={"100%"}>
      <VStack>
        ...
        <Heading as='h1' textAlign='center'>Editar Asignatura</Heading>
