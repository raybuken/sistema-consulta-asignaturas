...
import { createNewKnowledgeArea } from '../../helpers/knowledgeArea/knowledgeAreaHelpers';
import { createKnowledgeAreaSchema } from '../../validations/knowledgearea';

function AddKnowledgeAreaForm() {
    ...
    createNewKnowledgeArea(values)
      ...
      .then(data => {
        ...
        if(!data.ok){
          ...
          resetForm()
          toast({
            title: "Area de conocimiento Creado",
            description: "Se ha añadido el area de conocimiento exitosamente!",
          })
        }
  ...
  return (
    <Box rounded='md' padding='5' boxShadow='lg' role='group' minH={400} w={"100%"}>
      <VStack>
        ...
        <Heading as='h1' textAlign='center'>Crear Area de conocimiento</Heading>

      </VStack>
      <Formik
        initialValues={initialValues}
        onSubmit={handleSubmit}
        validationSchema={createKnowledgeAreaSchema}
      >
...
export default AddKnowledgeAreaForm